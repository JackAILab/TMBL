...
class MultiHeadAttention(nn.Module): # MultiHeadAttention(n_head=4, d_emb_q=256, d_emb_v=128, d_k=512, d_v=1024)
    ...
    def __init__(self, n_head, d_emb_q, d_emb_v, d_k=512, d_v=1024, dropout=0.1): # Jack Add
        ...
        self.w_q = nn.Linear(d_emb_q, self.d_k, bias=False) # you can also try nn.Conv1d(d_emb_q, self.d_k, 3, 1, 1, bias=False)
        ...
        self.gate_activate = nn.Tanh() # Other functions liek Sigmoid and ReLU you can also try
    ...
    def forward(self, q, k, v, mask1=None, mask2=None):
        ...
        # result = result * gate_ # Jack 0529 19:40 取消门控的模态噪声过滤机制 即取消FBP
